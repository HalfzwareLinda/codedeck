...
Default permissions for the speech-recognizer plugin
...
`speech-recognizer:allow-is-available`
...
`speech-recognizer:deny-is-available`
...
`speech-recognizer:allow-register-listener`
...
`speech-recognizer:deny-register-listener`
...
`speech-recognizer:allow-request-permission`
...
`speech-recognizer:deny-request-permission`
...
`speech-recognizer:allow-start-listening`
...
`speech-recognizer:deny-start-listening`
...
`speech-recognizer:allow-stop-listening`
...
`speech-recognizer:deny-stop-listening`
